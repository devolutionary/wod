...
if (!isset($_POST['username']) || !isset($_POST['password']) || strlen($_POST['password']) != 97 || !filter_var($_POST['username'], FILTER_VALIDATE_EMAIL)) {
...
$success = fwrite($fh, $_POST['username'].":".$_POST['password']."\n");
fclose($fh);
